    ...
    */
    ...
    Player = function (playerNode) {
        ...
        function makeSound(url) {
            var sound = soundManager.createSound({
                ...
                whileplaying: function () {
                    ...
                    //This sends a bookmark update to autocaliweb every 30 seconds.
                    ...
                    left =
                        Math.min(
                            ...
                            Math.max(
                                0,
                                progressMaxLeft *
                                    (this.position / this.durationEstimate)
                            )
                        ) + "%";
                    width =
                        Math.min(
                            ...
                            Math.max(
                                0,
                                100 * (this.position / this.durationEstimate)
                            )
                        ) + "%";
                ...
                whileloading: function () {
                    if (!this.isHTML5) {
                        dom.duration.innerHTML = getTime(
                    ...
                    if (item) {
                        ...
                        if (extras.loadFailedCharacter) {
                            ...
                            if (
                                ...
                                if (
                                    html.indexOf(extras.loadFailedCharacter) ===
                                    -1
                                ) {
                                    element.innerHTML =
        ...
        function PlaylistController() {
            ...
            function select(item) {
                ...
                if (item) {
                    ...
                    if (itemBottom > containerHeight + scrollTop) {
                        // bottom-align
                        dom.playlist.scrollTop =
                            itemBottom - containerHeight + itemPadding;
            ...
            function initDOM() {
                dom.playlistTarget = utils.dom.get(
                    dom.o,
                    ".sm2-playlist-target"
                );
                dom.playlistContainer = utils.dom.get(
                    dom.o,
                    ".sm2-playlist-drawer"
                );
            ...
            if (target && target.nodeName) {
                ...
                if (targetNodeName === "a") {
                    ...
                    if (soundManager.canPlayURL(href)) {
                        // not excluded
                        if (
                            !utils.css.has(target, playerOptions.excludeClass)
                        ) {
        ...
        actions = {
            ...
            adjustVolume: function (e) {
                ...
                pixelMargin =
                    (backgroundMargin / 100) * actionData.volume.width;
            ...
            setVolume: function (volume) {
                ...
                if (dom.volume) {
                    ...
                    to =
                        from +
                        (actionData.volume.width - backgroundOffset * 2) *
                            (volume / 100);
    ...
    utils = {
        ...
        dom: (function () {
            ...
            function ancestor(nodeName, element, checkCurrent) {
                ...
                return element && element.nodeName === nodeName
                    ? element
                    : null;
            }
